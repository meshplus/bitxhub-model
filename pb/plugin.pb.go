...
type AppchainPluginClient interface {
	...
	RollbackIBTP(ctx context.Context, in *IBTP, opts ...grpc.CallOption) (*RollbackIBTPResponse, error)
...
func (c *appchainPluginClient) RollbackIBTP(ctx context.Context, in *IBTP, opts ...grpc.CallOption) (*RollbackIBTPResponse, error) {
...
type AppchainPluginServer interface {
	...
	RollbackIBTP(context.Context, *IBTP) (*RollbackIBTPResponse, error)
...
func (*UnimplementedAppchainPluginServer) RollbackIBTP(ctx context.Context, req *IBTP) (*RollbackIBTPResponse, error) {
...
func _AppchainPlugin_RollbackIBTP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppchainPluginServer).RollbackIBTP(ctx, req.(*IBTP))
	}
	return interceptor(ctx, in, info, handler)
}

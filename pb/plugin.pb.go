...
type GetDataResponse struct {
	...
	EndTs     int64  `protobuf:"varint,6,opt,name=endTs,proto3" json:"endTs,omitempty"`
	EndRecvTs int64  `protobuf:"varint,7,opt,name=endRecvTs,proto3" json:"endRecvTs,omitempty"`
}
...
func (m *GetDataResponse) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *GetDataResponse) GetEndTs() int64 {
	if m != nil {
		return m.EndTs
	}
	return 0
...
func (m *GetDataResponse) GetEndRecvTs() int64 {
	if m != nil {
		return m.EndRecvTs
	}
	return 0
...
var fileDescriptor_22a625af4bc1cc87 = []byte{
	...
	,
}
...
func (m *GetDataResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EndRecvTs != 0 {
		i = encodeVarintPlugin(dAtA, i, uint64(m.EndRecvTs))
		i--
		dAtA[i] = 0x38
	}
	if m.EndTs != 0 {
		i = encodeVarintPlugin(dAtA, i, uint64(m.EndTs))
		i--
		dAtA[i] = 0x30
	}
	if m.Code != 0 {
		i = encodeVarintPlugin(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x28
	}
	if m.Idx != 0 {
...
func (m *GetDataResponse) Size() (n int) {
	...
	if m.Code != 0 {
		n += 1 + sovPlugin(uint64(m.Code))
	}
	if m.EndTs != 0 {
		n += 1 + sovPlugin(uint64(m.EndTs))
	}
	if m.EndRecvTs != 0 {
		n += 1 + sovPlugin(uint64(m.EndRecvTs))
	}
	return n
}

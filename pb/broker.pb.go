...
func (CheckPierResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f209535e190f2bed, []int{20, 0}
}
...
type InterchainTxWrapper struct {
	...
	Transactions      []*BxhTransaction                            `protobuf:"bytes,3,rep,name=transactions,proto3" json:"transactions,omitempty"`
...
var fileDescriptor_f209535e190f2bed = []byte{
	...
	,
}
...
func (m *InterchainTxWrapper) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Transactions = append(m.Transactions, &BxhTransaction{})

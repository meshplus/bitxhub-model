...
type GetTransactionResponse struct {
	Txs    *Transactions     `protobuf:"bytes,1,opt,name=txs,proto3,customtype=Transactions" json:"txs,omitempty"`
	TxMeta []TransactionMeta `protobuf:"bytes,2,rep,name=tx_meta,json=txMeta,proto3,customtype=TransactionMeta" json:"tx_meta,omitempty"`
}
...
type InterchainTxWrappers struct {
	...
	InterchainTxWrappers []*InterchainTxWrapper `protobuf:"bytes,2,rep,name=interchainTxWrappers,proto3" json:"interchainTxWrappers,omitempty"`
}
...
func (m *InterchainTxWrappers) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
type MultiInterchainTxWrappers struct {
	MultiWrappers []*InterchainTxWrappers `protobuf:"bytes,1,rep,name=multiWrappers,proto3" json:"multiWrappers,omitempty"`
}

func (m *MultiInterchainTxWrappers) Reset()         { *m = MultiInterchainTxWrappers{} }
func (m *MultiInterchainTxWrappers) String() string { return proto.CompactTextString(m) }
func (*MultiInterchainTxWrappers) ProtoMessage()    {}
func (*MultiInterchainTxWrappers) Descriptor() ([]byte, []int) {
	return fileDescriptor_f209535e190f2bed, []int{18}
}
func (m *MultiInterchainTxWrappers) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MultiInterchainTxWrappers) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MultiInterchainTxWrappers.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MultiInterchainTxWrappers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MultiInterchainTxWrappers.Merge(m, src)
}
func (m *MultiInterchainTxWrappers) XXX_Size() int {
	return m.Size()
}
func (m *MultiInterchainTxWrappers) XXX_DiscardUnknown() {
	xxx_messageInfo_MultiInterchainTxWrappers.DiscardUnknown(m)
}

var xxx_messageInfo_MultiInterchainTxWrappers proto.InternalMessageInfo

func (m *MultiInterchainTxWrappers) GetMultiWrappers() []*InterchainTxWrappers {
	if m != nil {
		return m.MultiWrappers
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*MultiInterchainTxWrappers)(nil), "pb.MultiInterchainTxWrappers")
...
var fileDescriptor_f209535e190f2bed = []byte{
	...
	,
}
...
func (m *GetTransactionResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.TxMeta) > 0 {
		for iNdEx := len(m.TxMeta) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.TxMeta[iNdEx].Size()
				i -= size
				if _, err := m.TxMeta[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintBroker(dAtA, i, uint64(size))
			}
	...
	if m.Txs != nil {
		{
			size := m.Txs.Size()
			i -= size
			if _, err := m.Txs.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintBroker(dAtA, i, uint64(size))
		}
...
func (m *MultiInterchainTxWrappers) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MultiInterchainTxWrappers) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MultiInterchainTxWrappers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.MultiWrappers) > 0 {
		for iNdEx := len(m.MultiWrappers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.MultiWrappers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MultiInterchainTxWrappers) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetTransactionResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v TransactionMeta
			m.TxMeta = append(m.TxMeta, v)
			if err := m.TxMeta[len(m.TxMeta)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MultiInterchainTxWrappers) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MultiInterchainTxWrappers: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MultiInterchainTxWrappers: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MultiWrappers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MultiWrappers = append(m.MultiWrappers, &InterchainTxWrappers{})
			if err := m.MultiWrappers[len(m.MultiWrappers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

...
type AssetExchangeInfo struct {
	...
	SenderOnSrc          string   `protobuf:"bytes,2,opt,name=senderOnSrc,proto3" json:"senderOnSrc,omitempty"`
	ReceiverOnSrc        string   `protobuf:"bytes,3,opt,name=receiverOnSrc,proto3" json:"receiverOnSrc,omitempty"`
	AssetOnSrc           uint64   `protobuf:"varint,4,opt,name=assetOnSrc,proto3" json:"assetOnSrc,omitempty"`
	SenderOnDst          string   `protobuf:"bytes,5,opt,name=senderOnDst,proto3" json:"senderOnDst,omitempty"`
	ReceiverOnDst        string   `protobuf:"bytes,6,opt,name=receiverOnDst,proto3" json:"receiverOnDst,omitempty"`
	AssetOnDst           uint64   `protobuf:"varint,7,opt,name=assetOnDst,proto3" json:"assetOnDst,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_2cc4e03d2c28c490 = []byte{
	...
	,
}

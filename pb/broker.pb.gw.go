...
func request_ChainBroker_SendTransactionSync_0(ctx context.Context, marshaler runtime.Marshaler, client ChainBrokerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Transaction
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SendTransactionSync(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ChainBroker_SendTransactionSync_0(ctx context.Context, marshaler runtime.Marshaler, server ChainBrokerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Transaction
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SendTransactionSync(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterChainBrokerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChainBrokerServer) error {
	...
	mux.Handle("POST", pattern_ChainBroker_SendTransactionSync_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ChainBroker_SendTransactionSync_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ChainBroker_SendTransactionSync_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterChainBrokerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChainBrokerClient) error {
	...
	mux.Handle("POST", pattern_ChainBroker_SendTransactionSync_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChainBroker_SendTransactionSync_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ChainBroker_SendTransactionSync_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "transaction_sync"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_ChainBroker_SendTransactionSync_0 = runtime.ForwardResponseMessage

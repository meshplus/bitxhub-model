...
const (
	...
	IBTP_ASSET_EXCHANGE_INIT    IBTP_Type = 4
	IBTP_ASSET_EXCHANGE_REDEEM  IBTP_Type = 5
	IBTP_ASSET_EXCHANGE_REFUND  IBTP_Type = 6
	IBTP_ASSET_EXCHANGE_RECEIPT IBTP_Type = 7
)
...
var IBTP_Type_name = map[int32]string{
	...
	2: "RECEIPT_FAILURE",
	3: "ROLLBACK",
	4: "ASSET_EXCHANGE_INIT",
	5: "ASSET_EXCHANGE_REDEEM",
	6: "ASSET_EXCHANGE_REFUND",
	7: "ASSET_EXCHANGE_RECEIPT",
}
...
var fileDescriptor_7576a0a5bf0190a3 = []byte{
	...
	,
}

...
type Content struct {
	...
	DidCaller     string   `protobuf:"bytes,9,opt,name=did_caller,json=didCaller,proto3" json:"did_caller,omitempty"`
	VcId          string   `protobuf:"bytes,10,opt,name=vc_id,json=vcId,proto3" json:"vc_id,omitempty"`
...
func (m *Content) GetDidCaller() string {
	if m != nil {
		return m.DidCaller
	}
	return ""
...
func (m *Content) GetTransactionId() string {
	if m != nil {
...
var fileDescriptor_7576a0a5bf0190a3 = []byte{
	...
	,
}
...
func (m *Content) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TransactionId) > 0 {
		...
		i = encodeVarintIbtp(dAtA, i, uint64(len(m.TransactionId)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.VcId) > 0 {
		i -= len(m.VcId)
		copy(dAtA[i:], m.VcId)
		i = encodeVarintIbtp(dAtA, i, uint64(len(m.VcId)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.DidCaller) > 0 {
		i -= len(m.DidCaller)
		copy(dAtA[i:], m.DidCaller)
		i = encodeVarintIbtp(dAtA, i, uint64(len(m.DidCaller)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.ArgsRb) > 0 {
...
func (m *Content) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DidCaller", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DidCaller = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 10:
			if wireType != 2 {

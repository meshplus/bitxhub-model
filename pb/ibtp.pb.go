...
const (
	...
	IBTP_ASSET_EXCHANGE_INIT    IBTP_Type = 5
	IBTP_ASSET_EXCHANGE_REDEEM  IBTP_Type = 6
	IBTP_ASSET_EXCHANGE_REFUND  IBTP_Type = 7
	IBTP_ASSET_EXCHANGE_RECEIPT IBTP_Type = 8
)
...
var IBTP_Type_name = map[int32]string{
	...
	3: "ROLLBACK",
	4: "RECEIPT_ROLLBACK",
	5: "ASSET_EXCHANGE_INIT",
	6: "ASSET_EXCHANGE_REDEEM",
	7: "ASSET_EXCHANGE_REFUND",
	8: "ASSET_EXCHANGE_RECEIPT",
}
...
var IBTP_Type_value = map[string]int32{
	...
	"ROLLBACK":               3,
	"RECEIPT_ROLLBACK":       4,
	"ASSET_EXCHANGE_INIT":    5,
	"ASSET_EXCHANGE_REDEEM":  6,
	"ASSET_EXCHANGE_REFUND":  7,
	"ASSET_EXCHANGE_RECEIPT": 8,
}
...
type IBTP struct {
	...
	Group map[string]uint64 `protobuf:"bytes,8,rep,name=group,proto3" json:"group,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// Message version
...
func (m *IBTP) GetGroup() map[string]uint64 {
	if m != nil {
		return m.Group
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]uint64)(nil), "pb.IBTP.GroupEntry")
...
var fileDescriptor_7576a0a5bf0190a3 = []byte{
	...
	,
}
...
func (m *IBTP) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Group) > 0 {
		for k := range m.Group {
			v := m.Group[k]
			baseI := i
			i = encodeVarintIbtp(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
			i -= len(k)
			copy(dAtA[i:], k)
			i = encodeVarintIbtp(dAtA, i, uint64(len(k)))
			i--
			dAtA[i] = 0xa
			i = encodeVarintIbtp(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x42
		}
	}
...
func (m *IBTP) Size() (n int) {
	...
	if len(m.Group) > 0 {
		for k, v := range m.Group {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovIbtp(uint64(len(k))) + 1 + sovIbtp(uint64(v))
			n += mapEntrySize + 1 + sovIbtp(uint64(mapEntrySize))
		}
	}
	l = len(m.Version)
	if l > 0 {
...
func (m *IBTP) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.Group == nil {
				m.Group = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
